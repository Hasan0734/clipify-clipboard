...
const Navbar = () => {
  ...
  return (
    <>
      <header className="bg-background flex  py-2 shrink-0 items-center gap-2 border-b transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-(--header-height)">
